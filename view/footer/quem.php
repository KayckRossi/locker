        ...
        <div class="card-group-vgr-cards">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Projeto iniciado/criado em 2021 - 2022</p>
                    ...
                    <div class="card profile-card-3">
                        ...
                        <div class="card-content">
                            <h2>Guilherme Kishida<small>Desenvolvedor Estudante</small></h3>
                                <div class="icon-block"><a href="https://github.com/kishidads"><i class="fab fa-github"></i></a><a href="#"> <i class="fab fa-linkedin"></i></a></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card profile-card-3">
                        ...
                        <div class="card-content">
                            <h2>Kayk Oliveira<small>Desenvolvedor Estudante</small></h3>
                                <div class="icon-block"><a href="https://github.com/KaykReis"><i class="fab fa-github"></i></a><a href="#"> <i class="fab fa-linkedin"></i></a></div>
                        </div>
                    </div>
                </div>
